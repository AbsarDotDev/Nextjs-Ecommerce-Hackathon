...
const CategoryCards = ({ category }: CategoryCardsProps) => {   
  return (
        <div className="w-full max-w-sm transition-all duration-300 transform hover:scale-105 hover:shadow-2xl">
          <Link href={`/shop/${category.name}`}>
            <Image
              ...
              alt="Logo"
            ></Image>
            <h6 className="font-bold text-[16px] pl-2 pt-3 pb-1">
{category.name}
          </h6>
            <p className="text-gray-800 text-[14px] pl-2 pb-4">
